...
// -------------- System Bypasses --------------
static __attribute__((always_inline, unused)) void wolfox_safe_exit(int code) {
#ifdef __arm64__
...
static int __attribute__((unused)) hook_dladdr(const void *addr, Dl_info *info) {
...
static void (*__attribute__((unused)) orig_exit_fn)(int);
static void __attribute__((unused)) hook_exit_fn(int code) { return; }

static int (*orig_sysctl)(int *, u_int, void *, size_t *, void *, size_t);
static int __attribute__((unused)) hook_sysctl(int *name, u_int namelen, void *oldp, size_t *oldlenp, void *newp, size_t newlen) {
...
static const char * __attribute__((unused)) hook_class_getImageName(Class cls) {
...
static void __attribute__((unused)) hook_alert_viewWillAppear(UIAlertController *self, SEL _cmd, BOOL animated) {
